...
class GenerateDevice extends React.Component {
  ...
  showAlertName () {
    const i = document.getElementById('missing_name')
              ...
              <div className='content'>
                ...
                <div className='title-form-device'>
                  <div class='terms3'>
                    ...
                    <p className='missing-name' id='missing_type' />
                  </div>
                  ...
                  <div class='section over-hide z-bigger'>
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-1'
                      value='1' checked={this.state.type === '1'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-2'
                      value='2' checked={this.state.type === '2'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-3'
                      value='3' checked={this.state.type === '3'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-4'
                      value='4' checked={this.state.type === '4'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-5'
                      value='5' checked={this.state.type === '5'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-6'
                      value='6' checked={this.state.type === '6'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-7'
                      value='7' checked={this.state.type === '7'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-8'
                      value='8' checked={this.state.type === '8'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-10'
                      value='10' checked={this.state.type === '10'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-11'
                      value='11' checked={this.state.type === '11'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-13'
                      value='13' checked={this.state.type === '13'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-14'
                      value='14' checked={this.state.type === '14'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-15'
                      value='15' checked={this.state.type === '15'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-16'
                      value='16' checked={this.state.type === '16'} onChange={this.changeRadio}
                    />
                    ...
                    <input
                      class='checkbox-tools' type='radio' name='tools' id='tool-17'
                      value='17' checked={this.state.type === '17'} onChange={this.changeRadio}
                    />
                ...
                <div className='title-form-device'>
                  ...
                  <div class='terms3'>
                    <p className='requirement'>*</p>
                    <h1 className='label-form-device'>NOMBRE DEL DISPOSITIVO</h1><br />
                    <span className='missing-name' id='missing_name' />
                  </div>
                </div>
                <div>
                  <input class='input-text-device' type='text' value={this.state.name} onChange={this.changeText} />
                </div>
