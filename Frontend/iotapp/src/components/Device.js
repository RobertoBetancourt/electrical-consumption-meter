...
export default function Device({ device: { id, type, name, state } }) {
  let icon_type = "otro";
  const device_type = JSON.stringify(type);
      ...
      <Popup
        trigger={
          <button className={`device-item ${state}`}>
            <div class="terms">
              <img
                className={`device-icon ${state}`}
                src={require("../icons/dispositivos/" + icon_type + ".png")}
                alt="Icon"
              />
        ...
        {(close) => (
          <div className="modal-info">
            ...
            <div className="actions">
              ...
              <button className="modificar" onClick={close}>
                {" "}
                Modificar
              </button>
            </div>
