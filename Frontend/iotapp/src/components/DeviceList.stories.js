...
export const defaultAddButton = [{ ...addButton, name: "Agregar Dispositivo" }];
...
storiesOf("DeviceList", module)
  ...
  .add("default", () => (
    <PureDeviceList devices={defaultDevices} addButton={defaultAddButton} />
  ))
  .add("withOffDevices", () => (
    <PureDeviceList
      devices={withOffDevices}
      {...actions}
  ...
  .add("empty", () => (
    <PureDeviceList devices={[]} {...actions} addButton={defaultAddButton} />
  ));
